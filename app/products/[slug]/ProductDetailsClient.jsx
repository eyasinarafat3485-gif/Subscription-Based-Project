  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50/60 font-sans">
      ...
      <main className="flex-1 py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full space-y-10">
        ...
        {/* Top Header Banner matching Plugins & Themes pages (Image 1 style) */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">
                Category: <span className="font-bold text-indigo-600">{product.category || 'WordPress Resources'}</span> • Original GPL File
              </p>
            </div>
          </div>

          {/* Dynamic Right Side: Default Promo Box OR Active Membership Countdown Box */}
          <CategoryBannerCTA />
        </div>
