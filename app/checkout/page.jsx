...
function CheckoutContent() {
  ...
  const [paymentMethod, setPaymentMethod] = useState('nagad'); // 'bkash' | 'nagad' | 'rocket'
  ...
  // Load single product details if product query param is provided
  useEffect(() => {
    ...
    <div className="min-h-screen bg-slate-50/70 text-slate-900 font-sans selection:bg-indigo-600 selection:text-white flex flex-col justify-between">
      <div>
        ...
        <main className="py-10 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-6">
          ...
          {/* Top Error Alert Banner (Matching Image 2 Red Warning Box) */}
          {errors.length > 0 && (
          ...
          {/* Main 2-Column Form Layout (Matching Image 2) */}
          <form onSubmit={handleSubmitOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-xs space-y-5">
              ...
              {/* Phone Field (EDITABLE / ACTIVE ACCESS) */}
              <div className="space-y-1">
                <label className="block text-xs font-extrabold text-slate-700">
              ...
              {/* Create Account Password Field (READONLY) */}
              <div className="space-y-1">
                <label className="block text-xs font-extrabold text-slate-700">
            ...
            {/* Right Column: Order Summary & Payment Gateway (5 Columns) */}
            <div className="lg:col-span-5 space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  ...
                  {/* Included Items Sample (Matching Reference Image 2) */}
              ...
              {/* Payment Methods Box (Matching Reference Image 2) */}
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">

                {/* Gateway Options Radio Group */}
                  ...
                  <div className={`rounded-xl border transition-all ${paymentMethod === 'nagad' ? 'border-indigo-500 bg-indigo-50/20' : 'border-slate-200'}`}>
                    ...
                    {paymentMethod === 'nagad' && (
                      <div className="p-4 pt-0 space-y-3 text-xs text-slate-700 border-t border-indigo-100/80">
                        {/* Instruction Text in Bengali matching image 2 */}
                ...
                {/* Place Order Submit Button (Matching Image 2 Button) */}
                <button
                  type="submit"
                  disabled={submitting}
