  ...
  return (
    <div className="space-y-6 max-w-4xl relative">
      <div>
        ...
        <p className="text-slate-500 text-xs mt-1">View your guest account details and coupon access.</p>
      </div>
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-6 relative min-h-[350px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-xs">
          ...
          <div>
            <label className="block text-slate-700 font-bold mb-1.5">Activated Coupon Code</label>
            <div className="relative">
              <input
                type="text"
